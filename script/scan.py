...
class Scaner(controller.Controller):
    ...
    def build(self):
        ...
        if not os.path.exists(self.get_config('dir')):
            os.path.makedirs(self.get_config('dir'))
        return
        
    def run(self, end=99999, stop_condition=None):
        '''
        ...
        if self.save:
            ...
            if self.save_agent_data:
                ...
                try:
                    ...
                    self.print2('saving agent traj data failed.')
                ...
                try:
                    ...
                    self.print2('saving agent dataset failed. ')
